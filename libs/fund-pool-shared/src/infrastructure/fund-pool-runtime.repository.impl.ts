...
export class FundPoolRuntimeRepositoryImpl implements IFundPoolRuntimeRepository {
  ...
  private toDomain(doc: any): FundPoolRuntimeEntity {
    return new FundPoolRuntimeEntity({
      id: doc._id.toString(),
      poolId: doc.poolId,
      currentBalance: doc.currentBalance != null ? Number(doc.currentBalance.toString()) : 0,
      totalInflowAmount: doc.totalInflowAmount != null ? Number(doc.totalInflowAmount.toString()) : 0,
      totalOutflowAmount: doc.totalOutflowAmount != null ? Number(doc.totalOutflowAmount.toString()) : 0,
      totalManualAdjustAmount: doc.totalManualAdjustAmount != null ? Number(doc.totalManualAdjustAmount.toString()) : 0,
